...
const TONE_BG: Record<string, string> = {
  ...
  cyan:    "bg-cyan-500/15    ring-cyan-400/30    text-cyan-300",
  violet:  "bg-violet-500/15  ring-violet-400/30  text-violet-300",
  amber:   "bg-amber-500/15   ring-amber-400/30   text-amber-300",
  indigo:  "bg-indigo-500/15  ring-indigo-400/30  text-indigo-300",
};
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="relative">
          ...
          <div className="relative h-24 w-24 rounded-full bg-gradient-to-br from-emerald-400 to-cyan-400 grid place-items-center shadow-2xl shadow-emerald-500/30">
            <div className="h-20 w-20 rounded-full bg-[#050810] grid place-items-center">
              <div className="text-center">
                <p className="text-[9px] font-bold tracking-widest text-white/60 uppercase">TokenLens</p>
                <p className="mt-0.5 text-[10px] text-emerald-300">Core</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {PROVIDERS.map(p => {
        ...
        return (
          ...
          >
            ...
            <div
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 origin-left h-px bg-gradient-to-r from-white/15 to-transparent pointer-events-none"
              style={{
                width: `${radius - 56}px`,
