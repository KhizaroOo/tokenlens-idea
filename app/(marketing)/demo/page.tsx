    ...
    <>
      ...
      <SectionContainer className="pt-16 lg:pt-24 pb-12">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            ...
            <p className="mt-5 text-base lg:text-lg text-white/65 leading-relaxed max-w-xl">
      ...
      <SectionContainer className="py-12 lg:py-16">
        ...
        <div className="mt-10 grid md:grid-cols-2 lg:grid-cols-3 gap-3">
          {AGENDA.map((item, i) => (
            <div key={item.label} className="rounded-2xl border border-white/10 bg-white/[0.025] p-5 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="mt-1.5 text-xs text-white/55 leading-relaxed">{item.hint}</p>
              </div>
            </div>
          ))}
        </div>
