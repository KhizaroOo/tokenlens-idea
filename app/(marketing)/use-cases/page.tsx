...
const SIGNALS = [
  ...
  { type: "COST"        as const, icon: DollarSign, title: "LLM / API Cost Optimization", problem: "Running expensive models for jobs that cheaper models would handle fine.",            solution: "Model cost breakdown per workload + suggestions to downgrade safely.",            outcome: "Typical org reduces LLM spend 15-30% in first 60 days." },
  { type: "ADOPTION"    as const, icon: Briefcase,  title: "Business Productivity AI",    problem: "Bought 500 M365 Copilot licenses — no idea if business users actually use them.",     solution: "Per-app activity (Teams, Word, Excel, Outlook) and license utilization.",         outcome: "IT reclaims unused seats before next renewal — six- to seven-figure savings." },
  ...
  { type: "COST"        as const, icon: Users,      title: "Inactive Seat Detection",     problem: "Copilot/Cursor seats keep auto-renewing for users who haven't logged in for 60 days.",solution: "Automated idle-seat reports with reclaim workflow.",                              outcome: "Reduce license waste by 12-22% in first quarter." },
